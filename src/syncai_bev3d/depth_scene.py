...
data that does not need one. The plane matters when you have no depth -- `cli/scene.py`
is the path that assumes one for exactly that case, and says what the assumption costs.
