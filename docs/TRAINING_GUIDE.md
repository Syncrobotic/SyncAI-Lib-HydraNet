...
And know when to stop tuning. If `caution` sits at 0.200 and will not move, the question to
ask is not "which learning rate" — it is "how many examples of `caution` are actually in the
