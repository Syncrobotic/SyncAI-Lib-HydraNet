...
> rolls every step — and the quadruped line was removed on 2026-08-19, so that half is
> now history rather than a plan. The **fixed-camera**
...
view (removed with the quadruped line on 2026-08-19) built its scene from registered metric depth by
