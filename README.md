...
The [v1 scene annotation contract](docs/STUDIOA_SCENE_CONTRACT.md) defines the requested
classes. [AI annotation](docs/STUDIOA_AI_ANNOTATION.md) labels frames without requiring
human annotation; source provenance and uncertain regions remain explicit. Trained heads
are not changed by labelling alone.
